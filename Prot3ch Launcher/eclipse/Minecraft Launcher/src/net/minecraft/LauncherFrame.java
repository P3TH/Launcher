...
/*  96 */       String str = Util.executePost("https://login.minecraft.net/", localHashMap);
/*  97 */       if (str == null) {
...
/* 123 */       this.launcher.customParameters.put("userName", arrayOfString[2].trim());
...
/* 189 */       ??? = paramArrayOfString[2];
/* 190 */       String str3 = "25565";
/* 191 */       if (((String)???).contains(":")) {
/* 192 */         String[] arrayOfString = ((String)???).split(":");
/* 193 */         ??? = arrayOfString[0];
/* 194 */         str3 = arrayOfString[1];
/*     */       }
/*     */ 
/* 197 */       localLauncherFrame.customParameters.put("server", ???);
