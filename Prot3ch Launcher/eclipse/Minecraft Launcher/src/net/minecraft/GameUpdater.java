...
/*     */ 
/* 405 */         localObject = "\"" + localProperties.getProperty(getFileName(this.urlList[i])) + "\"";
/*     */ 
/* 407 */         if ((!forceUpdate) && (localObject != null)) localURLConnection.setRequestProperty("If-None-Match", (String)localObject);
/*     */ 
/* 409 */         j = ((HttpURLConnection)localURLConnection).getResponseCode();
/* 410 */         if (j / 100 == 3) {
...
/*     */     }
/*     */ 
/* 418 */     i = this.percentage = 10;
/*     */ 
/* 421 */     Object localObject = new byte[65536];
/* 422 */     for (int j = 0; j < this.urlList.length; j++) {
/* 423 */       if (arrayOfBoolean[j] != 0) {
...
/* 681 */       localObject1 = Launcher.class.getProtectionDomain().getCodeSource().getLocation();
/*     */ 
/* 683 */       localObject2 = (JarURLConnection)new URL("jar:" + ((URL)localObject1).toString() + "!/net/minecraft/Launcher.class").openConnection();
...
/* 706 */       localObject3 = (JarEntry)localEnumeration.nextElement();
/*     */ 
...
/* 721 */       localObject3 = (JarEntry)localEnumeration.nextElement();
/*     */ 
