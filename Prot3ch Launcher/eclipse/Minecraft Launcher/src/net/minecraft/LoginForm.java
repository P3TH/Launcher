...
/*  19 */       if (paramAnonymousHyperlinkEvent.getEventType() == HyperlinkEvent.EventType.ACTIVATED)
/*     */         try {
/*  21 */           Util.openLink(paramAnonymousHyperlinkEvent.getURL().toURI());
...
/*     */       public void actionPerformed(ActionEvent paramAnonymousActionEvent) {
/*  77 */         paramLauncherFrame.playCached(LoginForm.this.userName.getText(), LoginForm.this.playOfflineAsDemo);
/*     */       }
/*     */     });
...
/*     */       public void actionPerformed(ActionEvent paramAnonymousActionEvent) {
/*  85 */         new OptionsPanel(paramLauncherFrame).setVisible(true);
/*     */       }
/*     */     });
/*     */   }
/*     */ 
...
/* 255 */             super.paint(paramAnonymousGraphics);
/*     */ 
/* 257 */             int i = 0;
/* 258 */             int j = 0;
/*     */ 
/* 262 */             FontMetrics localFontMetrics = paramAnonymousGraphics.getFontMetrics();
...
/*     */ 
/* 271 */             paramAnonymousGraphics.drawLine(i + 2, j, i + k - 2, j);
/*     */           }
/*     */ 
/*     */           public void update(Graphics paramAnonymousGraphics)
/*     */           {
/* 276 */             paint(paramAnonymousGraphics);
/*     */           }
/*     */         };
...
/*     */             try {
/* 285 */               Util.openLink(new URL("http://www.minecraft.net/register.jsp").toURI());
/*     */             } catch (Exception localException) {
...
/*     */ 
/* 305 */     return localTransparentPanel1;
/*     */   }
/*     */ 
...
/*     */ 
/*     */       public void paint(Graphics paramAnonymousGraphics) {
/* 314 */         super.paint(paramAnonymousGraphics);
/*     */ 
/* 316 */         int i = 0;
/* 317 */         int j = 0;
/*     */ 
/* 321 */         FontMetrics localFontMetrics = paramAnonymousGraphics.getFontMetrics();
...
/*     */ 
/* 330 */         paramAnonymousGraphics.drawLine(i + 2, j, i + k - 2, j);
/*     */       }
/*     */ 
/*     */       public void update(Graphics paramAnonymousGraphics)
/*     */       {
/* 335 */         paint(paramAnonymousGraphics);
/*     */       }
/*     */     };
